...
public static class DependencyInjectionExtension
{
    ...
    private static void AddRepositories(IServiceCollection services)
    {
        ...
        services.AddScoped<IUserReadOnlyRepository, ChangePassword>();
        services.AddScoped<IUserWriteOnlyRepository, ChangePassword>();
        services.AddScoped<IUserUpdateOnlyRepository, ChangePassword>();
    }
